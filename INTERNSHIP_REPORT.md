...
| August 14–17, 2026 | Real deployment of the 12 stacks on AWS, diagnosis and fix of 4 real blocking bugs, complete pipeline execution (Blue/Green validated), full infrastructure teardown, writing of the validation report | AWS CLI, AWS Console, Docker, Trivy | First fully successful end-to-end run; Appendix J produced |
...
| Final internship report | This document, complemented by Appendix J (technical validation report) |
...
| Validation report for the real run of 2026-08-15 | Appendix J |
...
## Appendix J — Technical validation report (real run of 2026-08-15)

*Previously a standalone document, merged into this report so that it is self-contained. The 17 screenshots it references live in `preuves/`.*
